...
const Shop = () => {
  return (
    <div className="bg-white/10 mx-5 mb-4 px-4 py-4 rounded-lg">
      <h1 className="text-center text-black font-medium text-2xl mb-3">Shop</h1>
      <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-xl:grid-cols-2 gap-4">
        <div className="rounded overflow-hidden shadow-lg bg-white/20">
          ...
          <div className="px-3 py-4">
            <div className="font-bold text-black  text-xl">SEGA Rank - $4.99</div>
            <p className="text-black/70 text-base pb-3">
        ...
        <div className="rounded overflow-hidden shadow-lg bg-white/20 relative">
          ...
          <div className="px-3 py-4 absolute bottom-0">
            <div className="font-bold text-black text-xl">Unban - $9.99</div>
            <p className="text-black/70 text-base pb-3">
